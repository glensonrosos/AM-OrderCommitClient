...
function AudioPlayer() {
  ...
  return (
    ...
    <Container>
      ...
      <Badge color="error" badgeContent={notReqAttDepts?.LOGS} sx={{ "& .MuiBadge-badge": { fontSize: 40, height: 50, minWidth: 50, borderRadius:50 } }}>
          <Typography variant="h2" className={classes.title} >LOGISTICS</Typography>  
      </Badge><br/> <br/> <br/>
